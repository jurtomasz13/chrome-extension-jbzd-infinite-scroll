...
async function getPageMemes(pageNum) {
  const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(`https://jbzd.com.pl/str/${pageNum}`);
